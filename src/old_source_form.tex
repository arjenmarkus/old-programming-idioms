...
\begin{itemize}
\item
Fixed form is often identified by \verb+.f+ or for some old compilers on Windows \verb+.for+, but
...
\item
On file systems where file names are case-sensitive, such Linux, an extension \verb+.F+ or \verb+.F90+
...
equivalent in C. There they are called pragmas and function in much the same way.}
