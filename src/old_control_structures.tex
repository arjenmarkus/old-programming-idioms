...
these constraints were violated, quite often a \verb+DO+ loop would run at least once.
Consider this code:
%
\begin{verbatim}
...
Some compilers still provide an option to allow for the FORTRAN 66 semantics,\cite{Intel}
