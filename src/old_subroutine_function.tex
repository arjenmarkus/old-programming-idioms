...
Nowadays, you should use a module to implement the functions or if that is
...
The modern alternative is to use a module and module variables to store the intermediate results.
